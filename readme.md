...
To access Redis Insight, go to http://x.x.x.x:port where x.x.x.x is the IP address of the instance and port is the port set in the environment variables file.
